...
Requires:  %{?scl_prefix}felix-framework
Requires:  %{?scl_prefix}apache-commons-logging
# Provides so that SCL-ized hawtjni works.
Provides:  %{?scl_prefix}mvn(org.apache.xbean:xbean:pom:) = %{version}
Provides:  %{?scl_prefix}mvn(org.apache.xbean:xbean) = %{version}
Provides:  %{?scl_prefix}mvn(org.apache.xbean:xbean-classpath) = %{version}
Provides:  %{?scl_prefix}mvn(org.apache.xbean:xbean-bundleutils) = %{version}
Provides:  %{?scl_prefix}mvn(org.apache.xbean:xbean-finder) = %{version}
Provides:  %{?scl_prefix}mvn(org.apache.xbean:xbean-naming) = %{version}
Provides:  %{?scl_prefix}mvn(org.apache.xbean:xbean-reflect) = %{version}
...
%changelog
* Tue Nov 19 2013 Severin Gehwolf <sgehwolf@redhat.com> - 3.13-8
- Fix Rs/BRs. Add manual provides so that SCL-ized hawtjni works.
- Don't use Java auto-requires.

* Mon Nov 18 2013 Severin Gehwolf <sgehwolf@redhat.com> - 3.13-7
- Use SCL-ized packages in BRs.

* Fri Nov 08 2013 Severin Gehwolf <sgehwolf@redhat.com> - 3.13-6
- SCL-ize xbean.
